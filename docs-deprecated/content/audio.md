...
imports: [audioManager, Sprite, Text, delay]
---

# Sound & Music

Zap provides a complete audio system for sound effects and background music with volume controls and mute support.
...
audioManager.unmute();
audioManager.toggleMute();
audioManager.isMuted(); // Returns boolean
```
